...
# scripts/cellbender_cuda_M.sh
# Run CellBender on male samples

#SBATCH --job-name=cellbender_M
#SBATCH --output=logs/cellbender_M_%A_%a.out
#SBATCH --error=logs/cellbender_M_%A_%a.err
...
echo "Running CellBender on male sample: $sample"

# Set up working directory
WORKDIR="mapped_reads_M/${sample}"
mkdir -p "$WORKDIR"

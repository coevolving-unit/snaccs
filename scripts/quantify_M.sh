...
# scripts/quantify_M.sh
# Quantify UMIs for male samples

#SBATCH --job-name=quantify_males
#SBATCH --output=logs/quantify_males_%A_%a.out
#SBATCH --error=logs/quantify_males_%A_%a.err
#SBATCH --mem=64G
#SBATCH --time=4:00:00
...
alevin-fry quant \
    ...
    -o mapped_reads_M/"${sample}"_quant_res \
    --tg-map transcriptome_splici_fl86/transcriptome_splici_fl86_t2g_3col.tsv \
